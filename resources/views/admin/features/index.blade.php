                    ...
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                <th width="20%">{{__('keywords.icon')}}</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <x-action-button href="{{ route('admin.features.edit', ['feature' => $feature]) }}"
                                        type="edit"></x-action-button>

                                    <x-action-button href="{{ route('admin.features.show', ['feature' => $feature]) }}"
